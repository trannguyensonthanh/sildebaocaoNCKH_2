<!-- SLIDE 13.1: TRÌNH DIỄN KẾT QUẢ TRỰC QUAN CỦA ViT -->
<section 
...
>
  <div class="w-full h-full flex flex-col justify-center items-center text-white drop-shadow-xl">
    <h2 class="!text-5xl md:text-6xl text-center font-extrabold tracking-tight text-tech-highlight/90 bg-black/80 px-8 py-6 rounded-2xl mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-9xl mx-auto">
      ...
      <div class="fragment" data-fragment-index="1">
        <div class="bg-white/20 p-6 rounded-xl h-full flex flex-col justify-center">
          <img src="/images/attention-map-showcase.png" alt="Attention Map Visualization" class="rounded-lg shadow-2xl w-full md:w-[900px] h-auto mx-auto"/>
          <p class="text-center text-lg italic text-white mt-4 bg-black/50 px-3 py-2 rounded-lg">
